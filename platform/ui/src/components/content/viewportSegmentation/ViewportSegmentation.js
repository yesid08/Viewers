...
import './ViewportSegmentation.styl';
...
const ViewportSegmentation = ({
  ...
  const [t] = useTranslation('ViewportSegmentation');
  ...
  return (
    <div className="ViewportSegmentation">
...
ViewportSegmentation.propTypes = {
...
export default ViewportSegmentation;
